...
local function randomNumberString()
    local result = ""
    for i = 1, 23 do
...
Window:AddToggle({
    Title = "No Car",
    Description = "For clean up a dead body, avoid the situation of retrieving bodies run over by car",
    Tab = miscTab,
    Callback = function(Boolean) 
        if Boolean then
            removalRunning = true
